...
interface RanchoSantaFeWeddingPlannerClientProps {
  ranchoSantaFeVenues: VenueDocument[];
}

// Why Rancho Santa Fe content
const whyRanchoSantaFe = [
  {
    title: "Prestigious Estate Settings",
    description: "Rancho Santa Fe offers some of California's most exclusive private estates and The Covenant's timeless elegance.",
    icon: Home,
  },
  {
    title: "World-Class Golf Courses",
    description: "Home to Rancho Valencia Resort and pristine golf course venues perfect for sophisticated celebrations.",
    icon: Trees,
  },
  {
    title: "Unmatched Privacy",
    description: "One of America's most affluent communities, RSF offers the ultimate in privacy and exclusivity for your wedding.",
    icon: Crown,
  },
  {
    title: "Mediterranean Elegance",
    description: "Spanish Colonial architecture and lush landscapes create a romantic Old California atmosphere.",
    icon: Building2,
  },
];
...
export default function RanchoSantaFeWeddingPlannerClient({ ranchoSantaFeVenues }: RanchoSantaFeWeddingPlannerClientProps): JSX.Element {
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        >
          ...
          <div className="absolute inset-0">
            <Image
              ...
              alt="Rancho Santa Fe estate wedding venue"
              fill
              priority
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            ...
            >
              ...
              <nav className="flex items-center gap-2 text-sm text-white/70 mb-6">
                ...
                <span>/</span>
                <span className="text-blush-300">Rancho Santa Fe</span>
              </nav>
              ...
              <p className="mt-6 text-lg sm:text-xl text-cream-100/90 leading-relaxed max-w-2xl">
                Your expert guide to planning an extraordinary Rancho Santa Fe wedding. From grand estate celebrations at Rancho Valencia Resort to intimate private gatherings in The Covenant, we create unforgettable luxury experiences.
              </p>
              ...
              <div className="mt-10 flex flex-wrap gap-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70">RSF Weddings</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-serif font-semibold text-white">Preferred</p>
                    <p className="text-sm text-white/70">Rancho Valencia</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <Link href="/#contact" onClick={() => umami.track("cta_click_consultation", { location: "rsf_hero" })}>
                  <Button size="lg" className="w-full sm:w-auto px-8">
                    Free Consultation
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Button>
                </Link>
                <Link href="/portfolio" onClick={() => umami.track("cta_click_portfolio", { location: "rsf_hero" })}>
                  <Button
                    variant="outline"
                    size="lg"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl font-serif font-medium text-charcoal-900">
                Why Get Married in Rancho Santa Fe?
              </h2>
              <p className="mt-6 text-lg text-charcoal-600">
                One of America&apos;s wealthiest and most exclusive communities, Rancho Santa Fe offers unparalleled privacy, stunning estates, and timeless Mediterranean elegance for your celebration.
              </p>
            </motion.div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {whyRanchoSantaFe.map((item, index) => (
                <motion.div
                  key={item.title}
                  initial={{ opacity: 0, y: 30 }}
                  animate={whyInView ? { opacity: 1, y: 0 } : {}}
        ...
        {/* Rancho Santa Fe Venues Section - Dynamic from Sanity */}
        <section ref={venuesRef} className="py-20 lg:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl font-serif font-medium text-charcoal-900">
                Rancho Santa Fe Wedding Venues
              </h2>
              <p className="mt-6 text-lg text-charcoal-600">
                We&apos;ve planned weddings at Rancho Santa Fe&apos;s most prestigious venues and know exactly how to bring your vision to life at each one.
              </p>
            </motion.div>

            {ranchoSantaFeVenues.length > 0 ? (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {ranchoSantaFeVenues.map((venue, index) => (
                  <motion.div
                    key={venue._id}
                    initial={{ opacity: 0, y: 30 }}
                    animate={venuesInView ? { opacity: 1, y: 0 } : {}}
                    ...
                    <div className="relative h-64">
                      {venue.image?.asset ? (
                        <Image
                          ...
                          alt={venue.image.alt || `${venue.name} wedding venue in Rancho Santa Fe`}
                          fill
                      ...
                      {venue.website && (
                        <a
                          ...
                          onClick={() => umami.track("link_click_venue_external", { venue: venue.name, location: "rsf_venues" })}
              ...
              <div className="text-center py-12">
                ...
                <p className="text-charcoal-500 mb-4">
                  Rancho Santa Fe venues coming soon. Check back later!
                </p>
            ...
            >
              ...
              <Link href="/#contact" onClick={() => umami.track("cta_click_venue_guidance", { location: "rsf_venues" })}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                ...
                <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl font-serif font-medium leading-tight">
                  Rancho Santa Fe Wedding
                  <br />
                  <span className="text-blush-300">Planning Services</span>
                </h2>
                <p className="mt-6 text-lg text-charcoal-300 leading-relaxed">
                  Whether you&apos;re planning a grand celebration at Rancho Valencia Resort or an intimate estate wedding in The Covenant, we offer bespoke planning services tailored to Rancho Santa Fe&apos;s distinguished lifestyle.
                </p>
                ...
                <div className="mt-8 space-y-4">
                  {[
                    ...
                    "Private estate wedding logistics",
                    "Rancho Valencia preferred vendor access",
                    "Luxury vendor curation & management",
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                  <Link href="/packages" onClick={() => umami.track("cta_click_view_packages", { location: "rsf_services" })}>
                    <Button size="lg" className="w-full sm:w-auto">
                      View Packages
                      <ArrowRight className="w-4 h-4 ml-2" />
                    </Button>
                  </Link>
                  <Link href="/san-diego-wedding-planner" onClick={() => umami.track("cta_click_all_services", { location: "rsf_services" })}>
                    <Button
                      variant="outline"
                      size="lg"
              ...
              <div className="relative">
                <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Rancho Santa Fe wedding ceremony planning"
                    fill
                    className="object-cover"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-medium text-charcoal-900">
                Ready to Plan Your
                <br />
                <span className="text-blush-500">Rancho Santa Fe Wedding?</span>
              </h2>
              <p className="mt-6 text-lg text-charcoal-600 max-w-2xl mx-auto">
                Let&apos;s discuss your vision for an extraordinary Rancho Santa Fe celebration. Schedule a complimentary consultation and discover how we can bring your estate wedding dreams to life.
              </p>

              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/#contact" onClick={() => umami.track("cta_click_consultation_final", { location: "rsf_cta" })}>
                  <Button size="lg" className="w-full sm:w-auto px-10">
                    Schedule Free Consultation
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Button>
                </Link>
                <a href="tel:+17602167427" onClick={() => umami.track("link_click_phone", { location: "rsf_cta" })}>
                  <Button
                    variant="outline"
                    size="lg"
              ...
              <p className="mt-6 text-sm text-charcoal-500">
                Serving Rancho Santa Fe, San Diego, and all of Southern California
              </p>
            </motion.div>
          </div>
        </section>

...
const laJollaVenues = [
  ...
  },
  {
    name: "La Jolla Cove",
    type: "Beach Ceremony",
    description: "Iconic coastal cliffs and stunning sunset ceremonies",
    image: "https://images.unsplash.com/photo-1544078751-58fee2d8a03b?q=80&w=2070",
    preferred: false,
  },
  {
    name: "Scripps Seaside Forum",
    type: "Oceanfront Venue",
    description: "Panoramic Pacific views at UC San Diego's stunning venue",
...
export default function LaJollaWeddingPlannerPage(): JSX.Element {
              ...
              {laJollaVenues.map((venue, index) => (
                ...
                >
                  <div className="relative h-64">
                    <Image
                      src={venue.image}
                      alt={`${venue.name} wedding venue in La Jolla`}
                      fill
                    ...
                    {venue.preferred && (
                      <div className="absolute top-4 right-4 px-3 py-1 bg-blush-500 text-white text-xs font-medium rounded-full">
                        Preferred Vendor
                      </div>
                    )}
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <span className="text-blush-300 text-sm font-medium">{venue.type}</span>

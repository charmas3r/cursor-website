...
const packages = [
  ...
  },
  {
    ...
    description:
      "Our 90-day package for couples who want comprehensive wedding management and peace of mind on their special day.",
    price: "3,500",
    priceNote: "Starting at",
    icon: Calendar,
    badge: "Best Value",
...
export default function PackagesPage(): JSX.Element {
  ...
  return (
    <main className="relative">
      ...
      {/* Trust Indicators with Google Reviews Badge */}
      <section className="py-8 bg-white border-b border-cream-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-10 text-charcoal-600">
            {/* Google Reviews Badge */}
            <a
              href="https://share.google/Pltvlw9njBabd209x"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => umami.track("link_click_google_reviews", { location: "packages_trust" })}
              className="flex items-center gap-2 px-4 py-2 bg-white rounded-full border-2 border-amber-200 hover:border-amber-400 hover:shadow-md transition-all duration-300"
            >
              ...
              <span className="font-semibold text-charcoal-900">5.0</span>
              <span className="text-sm text-charcoal-500">on Google</span>
            </a>

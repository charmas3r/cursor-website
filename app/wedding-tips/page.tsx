...
export default function WeddingTipsPage(): JSX.Element {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-lg sm:text-xl text-charcoal-600 leading-relaxed">
              From budgeting to the big day—expert insights from 15+ years
              and 500+ weddings to help you plan your perfect celebration.
            </p>
          </motion.div>

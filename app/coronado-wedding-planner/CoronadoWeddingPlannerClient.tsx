...
interface CoronadoWeddingPlannerClientProps {
  coronadoVenues: VenueDocument[];
}

// Why Coronado content
const whyCoronado = [
  {
    title: "Historic Hotel del Coronado",
    description: "The iconic Victorian beachfront hotel has hosted royalty, presidents, and celebrities since 1888.",
    icon: Landmark,
  },
  {
    title: "Pristine Beach Setting",
    description: "Coronado Beach is consistently ranked among America's best beaches with golden sand and perfect sunsets.",
    icon: Waves,
  },
  {
    title: "Island Exclusivity",
    description: "Connected by the stunning Coronado Bridge, the island offers a private resort atmosphere just minutes from downtown.",
    icon: Ship,
  },
  {
    title: "Timeless Elegance",
    description: "From Victorian architecture to modern luxury resorts, Coronado blends historic charm with contemporary sophistication.",
    icon: Building2,
  },
];
...
export default function CoronadoWeddingPlannerClient({ coronadoVenues }: CoronadoWeddingPlannerClientProps): JSX.Element {
      ...
      <main className="min-h-screen">
        ...
        >
          ...
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1600758208050-a22f17dc5f87?q=80&w=2070"
              alt="Coronado Beach wedding ceremony at sunset"
              fill
              priority
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            ...
            >
              ...
              <nav className="flex items-center gap-2 text-sm text-white/70 mb-6">
                ...
                <span>/</span>
                <span className="text-blush-300">Coronado</span>
              </nav>
              ...
              <p className="mt-6 text-lg sm:text-xl text-cream-100/90 leading-relaxed max-w-2xl">
                Your expert guide to planning the perfect Coronado wedding. From legendary celebrations at Hotel del Coronado to intimate beach ceremonies, we create unforgettable island experiences.
              </p>
              ...
              <div className="mt-10 flex flex-wrap gap-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70">Coronado Weddings</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <Link href="/#contact" onClick={() => umami.track("cta_click_consultation", { location: "coronado_hero" })}>
                  <Button size="lg" className="w-full sm:w-auto px-8">
                    Free Consultation
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Button>
                </Link>
                <Link href="/portfolio" onClick={() => umami.track("cta_click_portfolio", { location: "coronado_hero" })}>
                  <Button
                    variant="outline"
                    size="lg"
                    className="w-full sm:w-auto px-8 bg-white/10 border-white/30 text-white hover:bg-white/20"
                  >
                    View Coronado Weddings
                  </Button>
                </Link>
              </div>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl font-serif font-medium text-charcoal-900">
                Why Get Married in Coronado?
              </h2>
              <p className="mt-6 text-lg text-charcoal-600">
                Home to the legendary Hotel del Coronado and pristine beaches, Coronado Island offers a timeless blend of Victorian elegance and coastal beauty for your celebration.
              </p>
            </motion.div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {whyCoronado.map((item, index) => (
                <motion.div
                  key={item.title}
                  initial={{ opacity: 0, y: 30 }}
                  animate={whyInView ? { opacity: 1, y: 0 } : {}}
        ...
        {/* Coronado Venues Section - Dynamic from Sanity */}
        <section ref={venuesRef} className="py-20 lg:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl font-serif font-medium text-charcoal-900">
                Coronado Wedding Venues
              </h2>
              <p className="mt-6 text-lg text-charcoal-600">
                We&apos;ve planned weddings at Coronado&apos;s most iconic venues and know exactly how to bring your vision to life at each one.
              </p>
            </motion.div>

            {coronadoVenues.length > 0 ? (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {coronadoVenues.map((venue, index) => (
                  <motion.div
                    key={venue._id}
                    initial={{ opacity: 0, y: 30 }}
                    animate={venuesInView ? { opacity: 1, y: 0 } : {}}
                    ...
                    <div className="relative h-64">
                      {venue.image?.asset ? (
                        <Image
                          ...
                          alt={venue.image.alt || `${venue.name} wedding venue in Coronado`}
                          fill
                      ...
                      {venue.website && (
                        <a
                          ...
                          onClick={() => umami.track("link_click_venue_external", { venue: venue.name, location: "coronado_venues" })}
              ...
              <div className="text-center py-12">
                ...
                <p className="text-charcoal-500 mb-4">
                  Coronado venues coming soon. Check back later!
                </p>
            ...
            >
              ...
              <Link href="/#contact" onClick={() => umami.track("cta_click_venue_guidance", { location: "coronado_venues" })}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                ...
                <p className="mt-6 text-lg text-charcoal-300 leading-relaxed">
                  Whether you&apos;re planning a grand celebration at Hotel del Coronado or an intimate beach ceremony, we offer comprehensive planning services tailored to Coronado&apos;s unique island charm.
                </p>
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                  <Link href="/packages" onClick={() => umami.track("cta_click_view_packages", { location: "coronado_services" })}>
                    <Button size="lg" className="w-full sm:w-auto">
                      View Packages
                      <ArrowRight className="w-4 h-4 ml-2" />
                    </Button>
                  </Link>
                  <Link href="/san-diego-wedding-planner" onClick={() => umami.track("cta_click_all_services", { location: "coronado_services" })}>
                    <Button
                      variant="outline"
                      size="lg"
              ...
              <div className="relative">
                <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Coronado wedding ceremony planning"
                    fill
                    className="object-cover"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-medium text-charcoal-900">
                Ready to Plan Your
                <br />
                <span className="text-blush-500">Coronado Wedding?</span>
              </h2>
              <p className="mt-6 text-lg text-charcoal-600 max-w-2xl mx-auto">
                Let&apos;s discuss your vision for a beautiful Coronado celebration. Schedule a complimentary consultation and discover how we can bring your island wedding dreams to life.
              </p>

              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/#contact" onClick={() => umami.track("cta_click_consultation_final", { location: "coronado_cta" })}>
                  <Button size="lg" className="w-full sm:w-auto px-10">
                    Schedule Free Consultation
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Button>
                </Link>
                <a href="tel:+17602167427" onClick={() => umami.track("link_click_phone", { location: "coronado_cta" })}>
                  <Button
                    variant="outline"
                    size="lg"
              ...
              <p className="mt-6 text-sm text-charcoal-500">
                Serving Coronado, San Diego, and all of Southern California
              </p>
            </motion.div>
          </div>
        </section>

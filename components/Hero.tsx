        ...
        >
          ...
          >
            ...
            >
              ...
              <Link href="/#contact" onClick={() => umami.track("cta_click_free_consultation", { location: "hero" })}>
                <Button
                  variant="outline"
                  size="lg"
            ...
            >
              ...
              <a
                ...
                onClick={() => umami.track("link_click_google_reviews", { location: "hero_stats" })}
              ...
              <a
                ...
                onClick={() => umami.track("link_click_phone", { location: "hero_stats" })}
                className="flex items-center gap-2 text-white hover:text-blush-200 transition-colors"
              >
                <Phone className="w-5 h-5" />
                <span className="font-medium">(760) 216-7427</span>
              </a>
            </motion.div>
          </motion.div>
